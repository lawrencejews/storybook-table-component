...
export const Tablr = ({
  ...
  //Handle error with props.
  // 1. The header length must be at least 1
  // 2. The length of all of the rowa must equal the header length.
            ...
            {rows.map((r, rowIndex) => (
              <div
                ...
                style={{
                  ...
                  padding: cellPaddingMap[cellPadding],
                  border: `${borderWidth[borderWidth]} solid ${cellBorderColor}`,
                }}
              >
                {r[columnIndex]}
              </div>
...
Tablr.propsTypes = {
  ...
  borderWidth: PropTypes.oneOf(['thin', 'medium', 'large']),
